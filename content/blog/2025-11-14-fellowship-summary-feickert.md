...
During my [Winter 2025 URSSI Early-Career Fellowship](https://urssi.us/blog/2025/04/25/urssi-welcomes-first-early-career-fellows/) project, I researched how modern technologies and tools can assist researchers in easily, and automatically, creating fully reproducible hardware accelerated software environments for machine learning workflows (and other scientific applications that use CUDA) and compiled the results into a contribution to [The Carpentries Incubator](https://carpentries-incubator.org/).
I then taught this open source educational material to the broader scientific community at multiple workshops.

The material focused on using [Pixi](https://pixi.sh/) &mdash; a modern multi-platform software environment manager that builds on the conda and Python package ecosystems &mdash; and conda packages of the complete [NVIDIA CUDA software stack distributed on conda-forge](https://github.com/conda-forge/cuda-feedstock/tree/main/recipe) to declaratively specify the software requirements needed and automatically, and non-optionally, have an environment defined at the digest-level be created.
Pixi is written in Rust, and exploits Rust's speed to efficiently resolve complex dependency trees and produce full environment manifests known as lock files for _every_ Pixi operation performed.
...
This allows for users to define exact environments of remote machines, which might be a totally different computing platform, that they wish to resolve and lock a software environment for.
When combined with optimized builds of the entire CUDA ecosystem distributed as conda packages, thanks to the conda-forge community and NVIDIA's open source team, researchers can use these powerful technologies in concert to create complex environments for scientific analysis and machine learning that they know will work.
...
I piloted an [early version](https://indico.global/event/14745/) of the workshop for University of Wisconsin&ndash;Madison (UW&ndash;Madison) students and staff, and then took the information, experience, and feedback I gained there to teach a condensed 4 hour [tutorial](https://matthewfeickert-talks.github.io/reproducible-ml-for-scientists-with-pixi-scipy-2025/) at the SciPy 2025 conference.
...
All of this work and revisions of the teaching materials culminated in August, 2025 when I ran a [national-level workshop](https://indico.global/event/14982/) where 44 participants, from many domains in the physical and data science, came to UW&ndash;Madison from 11 universities, national laboratories, research organizations, and companies across the United States to learn how to apply these technologies to their research and production software problems.

Over the three days of the workshop we covered multiple aspects of reproducible science, software environment design, applications to CUDA machine learning workflows, and software deployments to remote machines.
...
I'm not only optimistic that they are, but encouraged by responses I've received in the long-term follow-up survey to the national-level workshop!
