...
<div class="row">
    <div class="col-md-6 px-3">
        <div class="card" style="width:100%">
            ...
            <div class="card-body">
                <h4 class="card-title">Prof. Daniel S. Katz  <a href="https://fediscience.org/@danielskatz" target="_blank" rel="noopener noreferrer"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-mastodon" viewBox="0 0 16 16">
